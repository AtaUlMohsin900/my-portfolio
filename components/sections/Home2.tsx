										...
										<div className="text-secondary-2 d-flex align-items-center">
											...
											<div className="text-dark">
												<div className="typewriter">
													<h1 className="fs-6 fw-medium">Hey, I’m ataulmohsin</h1>
												</div>
											</div>
											&lt;/span&gt;
										</div>
										<h1 className="fs-50 my-3">Full Stack<span className="text-linear-4">{'{'}Software{'}'}</span>&amp;developer<span className="flicker">_</span></h1>
